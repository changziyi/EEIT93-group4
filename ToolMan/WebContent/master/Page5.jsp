...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/css/cubeportfolio.css">
...
<body style="max-width: 1200px; width: 97%; margin: 100px auto; overflow-y: scroll;">
    <div id="js-filters-masonry-projects" class="cbp-l-filters-buttonCenter">
        ...
        <div data-filter=".identity" class="cbp-filter-item">
          	木工 <div class="cbp-filter-counter"></div>
        </div>
        <div data-filter=".web-design" class="cbp-filter-item">
      		      顆顆 <div class="cbp-filter-counter"></div>
        </div>
    ...
    <div id="js-grid-masonry-projects" class="cbp cbp-l-grid-masonry-projects">
        <div class="cbp-item graphic">
            <div class="cbp-caption">
                <div class="cbp-caption-defaultWrap">
                    <img width="10px" src="${pageContext.servletContext.contextPath}/image/jake.gif" alt="">
                </div>
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body"> <!-- 按鈕位置 -->
                <!-- 放大按鈕 --> <a href="${pageContext.servletContext.contextPath}/image/harden.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="<div class='title1'>地板地磚</div><br>和室地板重新刷漆">000</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cbp-item web-design logos">
            <div class="cbp-caption">
                <div class="cbp-caption-defaultWrap">
                    <img src="${pageContext.servletContext.contextPath}/image/harden.jpg" alt="">
                </div>
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            <a href="ajax-masonry-projects/project2.html" class="cbp-singlePage cbp-l-caption-buttonLeft" rel="nofollow">more info</a>
                            <a href="http://scriptpie.com/cubeportfolio/img/?i=1200x900/8d285b" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="World Clock Widget<br>by Paul Flavius Nechita">000</a>
                        </div>
                    </div>
                </div>
            </div>
            <a href="ajax-masonry-projects/project2.html" class="cbp-singlePage cbp-l-grid-masonry-projects-title" rel="nofollow">World Clock Widget</a>
                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            ...
                            <a href="http://scriptpie.com/cubeportfolio/img/?i=1200x900/701d46" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="WhereTO App<br>by Tiberiu Neamu">000</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            ...
                            <a href="http://scriptpie.com/cubeportfolio/img/?i=1200x900/f2adde" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Events and  More<br>by Tiberiu Neamu">000</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            ...
                            <a href="http://scriptpie.com/cubeportfolio/img/?i=1200x900/6d3898" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Ski * Buddy<br>by Tiberiu Neamu">000</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            ...
                            <a href="http://scriptpie.com/cubeportfolio/img/?i=1200x900/89ca22" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">000</a>
                        </div>
                    </div>
                </div>
            </div>
            <a href="ajax-masonry-projects/project7.html" class="cbp-singlePage cbp-l-grid-masonry-projects-title" rel="nofollow">Seemple* Music for iPad</a>
            <div class="cbp-l-grid-masonry-projects-desc">graphic / logos</div>
        </div>
...
<!--     <script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script> -->
    ...
    <!-- load cubeportfolio -->
    <script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/jquery.cubeportfolio.min.js"></script>

    <!-- init cubeportfolio -->
    <script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/cubemain.js"></script>
</body>
</html>
